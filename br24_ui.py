...
class br24_ctrl_window(threading.Thread):
    def __init__(self, master, br, refresh_period=500):
        ...
        self.fp_opts = ['Auto']
        print(self.fp_opts.extend(list(range(1,0x50))))
        ...
        self.radar_range_cbox = tkinter.ttk.Combobox(self.frame, values=self.radar_range_opts)
        ...
        self.interference_reject_cbox = tkinter.ttk.Combobox(self.frame, values=self.interference_reject_opts)
        ...
        self.target_boost_cbox = tkinter.ttk.Combobox(self.frame, values=self.target_boost_opts)
        ...
        self.local_interference_cbox = tkinter.ttk.Combobox(self.frame, values=self.local_interference_opts)
        self.local_interference_cbox.pack()
        
        self.fp_frame = tk.Frame(self.frame)
        self.gain_label = tk.Label(self.fp_frame, text = "Gain:")
        self.gain_label.pack()
        self.gain_cbox = tkinter.ttk.Combobox(self.fp_frame, values=self.fp_opts)
        self.gain_cbox.pack()
        self.rainc_label = tk.Label(self.fp_frame, text = "Rain Clutter")
        self.rainc_label.pack()
        self.rainc_cbox = tkinter.ttk.Combobox(self.fp_frame, values=self.fp_opts[1:])
        self.rainc_cbox.pack()
        self.seac_label = tk.Label(self.fp_frame, text = "Sea Clutter:")
        self.seac_label.pack()
        self.seac_cbox = tkinter.ttk.Combobox(self.fp_frame, values=self.fp_opts)
        self.seac_cbox.pack()
